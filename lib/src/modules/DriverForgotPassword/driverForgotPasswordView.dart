...
import 'package:smart_ride/src/modules/DriverForgotPassword/driverForgotPasswordLogic.dart';
...
class DriverForgotPasswordView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DriverForgotPasswordController>(
init: Get.isRegistered<DriverForgotPasswordController>()
    ? Get.find<DriverForgotPasswordController>()
    : DriverForgotPasswordController(),
