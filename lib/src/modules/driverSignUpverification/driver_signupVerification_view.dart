...
import 'package:smart_ride/src/modules/driverSignUpverification/driver_signupVerification_logic.dart';
...
import 'package:smart_ride/src/modules/customwidget/app_loading.dart'; // ✅ Add loading widget import

class DriverSignUpVerificationView extends StatelessWidget {
  const DriverSignUpVerificationView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<DriverSignUpVerificationController>(
      init: DriverSignUpVerificationController(),
      builder: (controller) {
        return Stack(
          children: [
            Scaffold(
