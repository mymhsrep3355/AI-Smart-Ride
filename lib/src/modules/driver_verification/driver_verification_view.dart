...
import 'package:smart_ride/src/modules/driver_verification/driver_verification_logic.dart';
...
final controller = Get.isRegistered<DriverVerificationController>()
    ? Get.find<DriverVerificationController>()
    : Get.put(DriverVerificationController());
return GetBuilder<DriverVerificationController>(
  builder: (_) {
        return Scaffold(
