...
import 'package:smart_ride/src/modules/DriverForgotPasswordVerification/driverForgotPasswordVerificationLogic.dart';
...
class DriverForgotPasswordVerificationView extends StatelessWidget {
  const DriverForgotPasswordVerificationView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<DriverForgotPasswordVerificationController>(
init: Get.isRegistered<DriverForgotPasswordVerificationController>()
    ? Get.find<DriverForgotPasswordVerificationController>()
    : DriverForgotPasswordVerificationController(),
