...
import 'package:smart_ride/src/modules/passenger_signup_verifcation/passenger_signup_verifcation_logic.dart';
...
class PassengerSignUpVerificationView extends StatelessWidget {
  const PassengerSignUpVerificationView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<PassengerSignUpVerificationController>(
      init: PassengerSignUpVerificationController(),
      builder: (controller) {
        return Stack(
          children: [
            Scaffold(
