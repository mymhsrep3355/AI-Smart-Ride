...
import 'package:smart_ride/src/modules/driver_login/driver_login_logic.dart';
...
class DriverLoginView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<DriverLoginController>(
      builder: (controller) {
        return Stack(
          children: [
            Scaffold(
                            ...
                            children: [
                              ...
                              Center(
                                child: TextButton(
                                  ...
                                  child: Text(Texts.signUpOptionInLogin,
                                      style: StyleRefer.poppinsRegular.copyWith(
                                        fontSize: 13,
                                        color: AppColors.primary,
                                      )),
