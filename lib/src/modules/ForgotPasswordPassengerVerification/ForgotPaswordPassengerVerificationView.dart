...
import 'package:smart_ride/src/modules/ForgotPasswordPassengerVerification/ForgotPaswordPassengerVerificationLogic.dart';
...
class ForgotPasswordVerificationView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ForgotPasswordVerificationController>(
      init: ForgotPasswordVerificationController(),
      builder: (controller) {
        return Scaffold(
